...
/**
 * Shared MUI DataGrid dark mode styles for consistent theming
 * across Inventory and Users pages.
 */
export const dataGridDarkModeSx: SxProps<Theme> = {
...
/** Shared DataGrid className for dark mode theming */
export const dataGridClassName =
  'bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-200 dark:border-gray-700 !text-gray-700 dark:!text-gray-200';
