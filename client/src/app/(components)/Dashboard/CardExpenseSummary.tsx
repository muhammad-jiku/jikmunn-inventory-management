...
const CardExpenseSummary = () => {
  ...
  return (
    <div className='row-span-3 bg-white dark:bg-gray-800 shadow-md dark:shadow-gray-700/50 rounded-2xl flex flex-col justify-between border border-gray-100 dark:border-gray-700 transition-colors duration-200'>
      {isLoading ? (
