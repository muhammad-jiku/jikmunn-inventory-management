...
const StatCard = ({
  ...
  return (
    <div className='md:row-span-1 xl:row-span-2 bg-white dark:bg-gray-800 shadow-md dark:shadow-gray-700/50 col-span-1 shadow-md rounded-2xl flex flex-col justify-between'>
      {/* HEADER */}
      <div>
